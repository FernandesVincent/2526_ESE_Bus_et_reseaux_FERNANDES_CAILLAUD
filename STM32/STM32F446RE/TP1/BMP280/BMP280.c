...
void BMP280_Init(void)
{
    ...
    HAL_I2C_Mem_Read(&hi2c2, BMP280_I2C_ADDRESS<<1, 0x88, 1, calib, 24, 100);
...
void BMP280_read_register(uint8_t reg){
    HAL_I2C_Master_Transmit(&hi2c2, BMP280_I2C_ADDRESS<<1, (uint8_t[]){reg}, 1, HAL_MAX_DELAY);
    printf("Demande de lecture de l'ID du capteur BMP280\r\n");
    HAL_I2C_Master_Receive(&hi2c2, BMP280_I2C_ADDRESS<<1, data_buffer, 6, HAL_MAX_DELAY);
...
void BMP280_read_several_registers(uint8_t start_reg, uint8_t end_reg, uint8_t* buffer){
    ...
    HAL_I2C_Master_Transmit(&hi2c2, BMP280_I2C_ADDRESS<<1, (uint8_t[]){start_reg}, 1, HAL_MAX_DELAY);
    HAL_I2C_Master_Receive(&hi2c2, BMP280_I2C_ADDRESS<<1, data_buffer, num_regs, HAL_MAX_DELAY);
...
void BMP280_16_bits_word(uint8_t reg1, uint8_t reg2){
    HAL_I2C_Master_Transmit(&hi2c2, BMP280_I2C_ADDRESS<<1, (uint8_t[]){reg1}, 1, HAL_MAX_DELAY);
    HAL_I2C_Master_Receive(&hi2c2, BMP280_I2C_ADDRESS<<1, data_buffer, 2, HAL_MAX_DELAY);
